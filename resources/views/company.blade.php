...
<div class="content-section">
    <form id="registrationForm" method="POST" action="{{ route('company_register') }}"  enctype="multipart/form-data">
        @csrf
        <h1>Profile</h1>
        <div class="input-group">
            ...
            <div class="input-box">
                ...
                <input id="company_name" type="text" name="name" value="{{ old('name')  }}" required autofocus>
            ...
            <div class="input-box">
                ...
                value="{{ old('company_address') }}" required autofocus>
        ...
        <div class="input-group">
            ...
            <div class="input-box">
                ...
                <input id="office_phone" type="tel" name="office_phone" value="{{ old('office_phone') }}" pattern="[0-9]+" required autofocus>
            ...
            <div class="input-box">
                ...
                <input id="company_website" type="text" name="URL" value="{{ old('company_website') }}" required autofocus>
        ...
        <div class="input-box full-width">
            ...
            <textarea id="company_intro" name="profile" class="custom-textarea" rows="5" value="{{ old('profile') }}"   required></textarea>
